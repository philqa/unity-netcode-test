...
public class PlayerTransform : NetworkBehaviour {
    ...
    /// </summary>
    [SerializeField] private bool _usingServerMode;
    ...
    private void Awake() {
        ...
        var permission = _usingServerMode ? NetworkVariableWritePermission.Server : NetworkVariableWritePermission.Owner;
